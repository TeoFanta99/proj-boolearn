...
<div class="container width_modified_container">
    <div class="row mt-4">
            ...
            <a href="{{ route('user.show', $teacher->user->id) }}" class="text-decoration-none">
                <div class="card pt-3 border-0 shadow">
                    <div class="d-flex justify-content-center align-items-center" style="height: 200px;">
                        <img class="object-fit-cover border rounded" style="height: 100%;" src="{{ asset('storage/' . $teacher->image_url) }}" alt="">
                    </div>
                    <div class="card-body">
        ...
        <div class="col-3 p-2">
            <a href="{{ route('user.show', $teacher->user->id) }}" class="text-decoration-none">
                <div class="card pt-3 border-0 shadow">
                    <div class="d-flex justify-content-center align-items-center img_circle mx-auto" style="height: 250px;">
                        <img class="w-100 h-100 rounded-circle" src="{{ asset('storage/' . $teacher->image_url) }}" alt="">
                    </div>
                    <div class="card-body">
                        <h4>{{ $teacher->user->name }} {{ $teacher->user->lastname }}</h4>
                    </div>
