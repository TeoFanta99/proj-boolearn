<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Assicurati di utilizzare una password lunga e di cambiarla frequentemente per motivi di sicurezza.')
            }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="d-flex align-items-center gap-4">
            ...
            <p id='status' class=" fs-5 text-muted">{{ __('Salvato con successo!') }}</p>
            @endif
        </div>
    </form>
</section>