    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary d-flex justify-content-between h-100">
      <div class="col-1 d-flex justify-content-start">
        <div class="gap-2 d-lg-flex d-md-none">
          <a href="http://localhost:8000/login" class="d-lg-block d-none">Login</a>
          <a href="http://localhost:8000/register" class="d-lg-block d-none">Registrazione</a>
        </div>
      </div>
      <div>
        <button class="btn d-lg-none col-1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight"
      ...
      <div class="col-3 d-flex justify-content-center">
        <div class="collapse navbar-collapse d-lg-none col-3" id="navbarText">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex justify-content-center justify-content-lg-end">
            ...
            <li class="nav-item">
              <a class="nav-link text-center" href="#">
                <router-link :to="{ name: 'faq' }"><i class="fa-solid fa-house me-2"></i> FAQ</router-link>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-center" href="#">
                <router-link :to="{ name: 'contact' }"><i class="fa-solid fa-house me-2"></i> Contact</router-link>
              </a>
            </li>
          </ul>
        </div>
